...
lista_bots = [BotMarombeiro("Bambam"), BotGamer("Ninja"), BotEspelhado("oãoJ"), BotMinerin("Renato"), BotManezinho("Moquirido"), BotZangado("Tisca"), BotTriste("Sadboy"), BotMusical("Thiaguinho"), BotJose("José")]
